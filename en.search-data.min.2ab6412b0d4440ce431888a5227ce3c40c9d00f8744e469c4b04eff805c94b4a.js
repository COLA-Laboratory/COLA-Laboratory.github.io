...
In press # DaNuoYi: Evolutionary Multi-Task Injection Testing on Web Application Firewalls
Ke Li, Heng Yang+, Willem Visser
IEEE Trans. Software Engineering (TSE)
PDF | BiB @article{LiYV22, author = {Ke Li and Heng Yang and Willem Visser}, title = {DaNuoYi: Evolutionary Multi-Task Injection Testing on Web Application Firewalls}, journal = {CoRR}, volume = {abs/2206.05743}, year = {2022}, url = {https://arxiv.org/abs/2206.05743}, doi = {10.48550/arXiv.2206.05743}, eprinttype = {arXiv}, eprint = {2206.05743} } Why Not Looking backward?” A Robust Two-Step Method to Automatically Terminate Bayesian Optimization
...
Abs | PDF | Supp | BiB Some quality indicators have been proposed for benchmarking preference-based evolutionary multi-objective optimization algorithms using a reference point. Although a systematic review and analysis of the quality indicators are helpful for both benchmarking and practical decision-making, neither has been conducted. In this context, first, this paper reviews existing regions of interest and quality indicators for preference-based evolutionary multi-objective optimization using the reference point. We point out that each quality indicator was designed for a different region of interest. Then, this paper investigates the properties of the quality indicators. We demonstrate that an achievement scalarizing function value is not always consistent with the distance from a solution to the reference point in the objective space. We observe that the regions of interest can be significantly different depending on the position of the reference point and the shape of the Pareto front. We identify undesirable properties of some quality indicators. We also show that the ranking of preference-based evolutionary multi-objective optimization algorithms depends on the choice of quality indicators. @article{TanabeL23, author = {Ryoji Tanabe and Ke Li}, title = {Quality Indicators for Preference-based Evolutionary Multi-objective Optimization Using a Reference Point: A Review and Analysis}, journal = {CoRR}, volume = {abs/2301.12148}, year = {2023}, url = {https://arxiv.org/abs/2301.12148}, eprinttype = {arXiv}, eprint = {2301.12148} } A Data-Driven Evolutionary Transfer Optimization for Expensive Problems in Dynamic Environments
Ke Li*, Renzhi Chen+*, Xin Yao
IEEE Trans. Evolutionary Computation (TEVC)
10.1109/TEVC.2023.3307244
Abs | PDF | Supp | BiB Many real-world problems are computationally costly and the objective functions evolve over time. Data-driven, a.k.a. surrogate-assisted, evolutionary optimization has been recognized as an effective approach to tackle expensive black-box optimization problems in a static environment whereas it has rarely been studied under dynamic environments. This paper proposes a simple yet effective transfer learning framework to empower data-driven evolutionary optimization to solve expensive dynamic optimization problems. Specifically, a hierarchical multi-output Gaussian process is proposed to capture the correlation among data collected from different time steps with a linearly increased number of hyperparameters. Furthermore, an adaptive source task selection along with a bespoke warm staring initialization mechanisms are proposed to better leverage the knowledge extracted from previous optimization processes. By doing so, the data-driven evolutionary optimization can jump start the optimization in the new environment with a very limited computational budget. Experiments on synthetic benchmark test problems and a real-world case study demonstrate the effectiveness of our proposed algorithm in comparison with nine state-of-the-art peer algorithms. @article{LiCY22, author = {Ke Li and Renzhi Chen and Xin Yao}, title = {A Data-Driven Evolutionary Transfer Optimization for Expensive Problems in Dynamic Environments}, journal = {CoRR}, volume = {abs/2211.0287}, year = {2022}, url = {https://arxiv.org/abs/2211.02879}, eprinttype = {arXiv}, eprint = {2211.02879} } PyABSA: A Modularized Framework for Reproducible Aspect-based Sentiment Analysis
Heng Yang+, Ke Li
Proc. of the 32nd ACM International Conference on Information and Knowledge Management (CIKM'23) Demon Track
Abs | PDF | BiB| ≈ 35%
...
Abs | PDF | BiB
Conference # Exploring Structural Similarity in Fitness Landscapes via Graph Data Mining: A Case Study on Number Partitioning Problems
Mingyu Huang+, Ke Li
Porc. of the 32nd International Joint Conference on Artificial Intelligence (IJCAI'23), p. 5595\u0026ndash;5603, August, 2023.
Abs | PDF | Supp | BiB | ≈ 15% One of the most common problem-solving heuristics is by analogy. For a given problem, a solver can be viewed as a strategic walk on its fitness landscape. Thus if a solver works for one problem instance, we expect it will also be effective for other instances whose fitness landscapes essentially share structural similarities with each other. However, due to the black-box nature of combinatorial optimization, it is far from trivial to infer such similarity in real-world scenarios. To bridge this gap, by using local optima network as a proxy of fitness landscapes, this paper proposed to leverage graph data mining techniques to conduct qualitative and quantitative analyses to explore the latent topological structural information embedded in those landscapes. In our experiments, we use the number partitioning problem as the case and our empirical results are inspiring to support the overall assumption of the existence of structural similarity between landscapes within neighboring dimensions. Besides, experiments on simulated annealing demonstrate that the performance of a meta-heuristic solver is similar on structurally similar landscapes. Boosting Text Augmentation via Hybrid Instance Filtering Framework
Heng Yang+, Ke Li
...
UKRI and CEMPS co-funded PhD studentship to commence on 25th September 2023 or as soon as possible thereafter. For eligible students the studentship will cover Home tuition fees plus an annual tax-free stipend of at least £17,668 for 3.5 years full-time, or pro rata for part-time study. More detailed information can be found from here. A new PhD studentship is opening in our lab!!! This project is mainly led by our colleagues in the Engineering department. The topic is about trustworthy and explainable AI for smart energy system management. Please feel free to contact me about more details. PhD There are multiple opportunities available at the University of Exeter to fund your PhD study.
