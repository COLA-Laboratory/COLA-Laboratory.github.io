...
02/2023 – present
Interests: BO, MTL Alumni # PhD student Dr Joseph Billingsly
...
Neurocomputing
2022 | Survey Paper Exploratory Landscape Analysis (ELA) # Exploratory Landscape Analysis
...
Benchmarks # Real-Parameter Black-Box Optimization Benchmarking 2009: Noiseless Functions Definitions
...
2021 | Journal Paper
Algorithm Selection # Automated Algorithm Selection: Survey and Perspectives
...
Instance Space Analysis # Towards objective measures of algorithm performance across instance space
...
Fitness Landscape Analysis (FLA) # Fitness Landscapes
...
2017 | Journal Paper
Algorithm Performance and Problem Difficulty # Measuring Instance Difficulty for Combinatorial Optimization Problems
...
2000 | Journal Paper
Problem-Specific # On the Landscapes of Combinatorial Opitmization Problems
...
Landscape Visualization # Low-Dimensional Euclidean Embedding for Visualization of Search Spaces in Combinatorial Optimization
Krzysztof Michalak
IEEE Transactions on Evolutionary Computation (TEVC)
2019 | Journal Paper Projects and Websites # MATILDA LON Maps Flacco COCO Paper List of AutoML # HPO Essentials # Meta-Learning: A Survey
Joaquin Vanschoren
arXiv
2015 | Survey Paper
...
2015 | Conference Paper
AutoML # AutoML: A survey of the state-of-the-art
...
Feature Importance # An Efficient Approach for Assessing Hyperparameter Importance
...
2017 | Conference Paper
Loss Landscape # Visualizing the Loss Landscape of Neural Nets
...
NeurIPS'21: Proc. of the 35th Conference on Neural Information Processing Systems
2021 | Conference Paper
Related Papers # Efficient Global Optimization of Expensive Black-Box Functions
...
GBFLAT # Framework # Under construction. Installation # Under construction. Documentation # Local Optima Network # class GBFLAT.LON.LocalOptimalNetwork() This is the general object we use to construct, access, analyze and manipulate LONs.
...
Whether to calculate additional node attributes, e.g., clustering coefficients and various centrality metrics. This could take to additional time for LON construction. Quick Start # Here we provide a simple yet comprehensive guide to illustrate the core functions of GBFLAT. Say, for example, we want to study the landscape characteristics of number partitioning problem (NPP) with 10 items.
...
`}),e.add({id:18,href:"/docs/research/supp/supp_deto/",title:"Supplementary",section:"Docs",content:` Supplementary Materials # This website maintains the supplementary materials related to the following paper:
...
@article{LiC22, author = {Ke Li and Renzhi Chen}, title = {Batched Data-Driven Evolutionary Multi-Objective Optimization Based on Manifold Interpolation}, journal = {{IEEE} Trans. Evol. Comput.}, pages = {1--15}, year = {2022}, note = {accepted for publication} } `}),e.add({id:20,href:"/docs/research/supp/supp_ranknet/",title:"Supplementary",section:"Docs",content:` Supplementary Materials # This website maintains the supplementary materials related to the following paper:
