...
if False, then no edge weights will be included in the LON (or say, all edges have equal weights). The introducing of edge weights will also enable a richer set of node attributes, e.g., weighted degree and weighted clustering coefficient.
**LocalOptimalNetwork.describe**() -> pd.DataFrame Obtain a pandas dataframe containing basic descriptions of the LON.
...
**Ke Li**, Renzhi Chen, "Batched Data-Driven Evolutionary Multi-Objective Optimization Based on Manifold Interpolation", IEEE Trans. Evol. Comput., accepted for publication, 2022. It consists of the following parts:
...
**Ke Li**, Han Guo+, "Human-in-the-Loop Policy Optimization for Preference-Based Multi-Objective Reinforcement Learning", submitted for peer review, 2024. It consists of the following parts:
...
**Ke Li**, Guiyu Lai+, Xin Yao, "Interactive Evolutionary Multi-Objective Optimization via Learning-to-Rank", IEEE Trans. Evol. Comput., accepted for publication, 2022. It consists of the following parts:
