...
In press # Modeling Aspect Sentiment Coherency via Local Sentiment Aggregation
Heng Yang+, Ke Li
Proc. of the 18th Conference of the European Chapter of the Association for Computational Linguistics (EACL'24)
Abs | PDF | BiB
...
Shengbo Wang+, Ke Li
Proc. of the 38th Annual AAAI Conference on Artificial Intelligence (AAAI'24)
...
@article{LiC22, author = {Ke Li and Renzhi Chen}, title = {Batched Data-Driven Evolutionary Multi-Objective Optimization Based on Manifold Interpolation}, journal = {{IEEE} Trans. Evol. Comput.}, pages = {1--15}, year = {2022}, note = {accepted for publication} } `}),e.add({id:21,href:"/docs/research/supp/supp_pbmorl/",title:"Supplementary",section:"Docs",content:` Supplementary Materials # This website maintains the supplementary materials related to the following paper:
